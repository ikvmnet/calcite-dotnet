...
namespace Apache.Calcite.Extensions.Runtime
{
    ...
    /// <summary>
    /// A compiled plan of the <c>ClrDataCursorConvention</c> calling convention, opened against a
    ...
    /// </remarks>
    public interface IClrDataCursorBindable : IClrBindableBase
    {
        ...
        ClrDataCursor Open(DataContext root);
        ...
        /// <returns>The cursor, positioned before the first row.</returns>
        ValueTask<ClrDataCursor> OpenAsync(DataContext root, CancellationToken cancellationToken);
