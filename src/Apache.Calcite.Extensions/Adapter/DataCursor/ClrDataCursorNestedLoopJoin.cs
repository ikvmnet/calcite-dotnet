...
namespace Apache.Calcite.Extensions.Adapter.DataCursor
{
    ...
    /// <see cref="ClrDataCursorHashJoin"/> leaves for it.
    ///
    ...
    /// </remarks>
    public class ClrDataCursorNestedLoopJoin : Join, ClrDataCursorRel
    {

        /// <summary>
        /// Creates a <see cref="ClrDataCursorNestedLoopJoin"/>.
        /// </summary>
        ...
        /// <returns></returns>
        public static ClrDataCursorNestedLoopJoin Create(RelNode left, RelNode right, RexNode condition, java.util.Set variablesSet, JoinRelType joinType)
        {
            ...
            return new ClrDataCursorNestedLoopJoin(cluster, traitSet, left, right, condition, variablesSet, joinType);
        }
        ...
        /// <param name="variablesSet"></param>
        /// <param name="joinType"></param>
        public ClrDataCursorNestedLoopJoin(RelOptCluster cluster, RelTraitSet traits, RelNode left, RelNode right, RexNode condition, java.util.Set variablesSet, JoinRelType joinType) :
        ...
        {
            return new ClrDataCursorNestedLoopJoin(getCluster(), traitSet, left, right, conditionExpr, getVariablesSet(), joinType);
        }
        ...
        /// </remarks>
        ClrDataCursorAsyncResult ImplementNLMarkJoinAsync(ClrDataCursorRelImplementor implementor, ClrEnumerablePrefer pref)
        {
            ...
            return implementor.ResultAsync(physType,
                ClrDataCursorBuiltInMethod.CallAsync(implementor, ClrDataCursorBuiltInMethod.LeftMarkNestedLoopJoinAsync.MakeGenericMethod(leftType, rightType, rowType),
        ...
        /// <param name="pref"></param>
        /// <returns></returns>
        ClrDataCursorAsyncResult ImplementNLJoinAsync(ClrDataCursorRelImplementor implementor, ClrEnumerablePrefer pref)
        {
            var leftResult = implementor.VisitChildAsync(this, 0, (ClrDataCursorRel)left, pref);
            var rightResult = implementor.VisitChildAsync(this, 1, (ClrDataCursorRel)right, pref);
            var rightResultSync = implementor.VisitChild(this, 1, (ClrDataCursorRel)right, pref);
            ...
            return implementor.ResultAsync(physType,
                ClrDataCursorBuiltInMethod.CallAsync(implementor, ClrDataCursorBuiltInMethod.NestedLoopJoinAsync.MakeGenericMethod(leftType, rightType, rowType),
                    leftResult.Expression,
                    implementor.Opener(rightResultSync),
                    implementor.OpenerAsync(rightResult),
                    selector,
        ...
        /// was unknown, which is what makes <c>IN</c> over a nullable column answer UNKNOWN.
        /// </remarks>
        ClrDataCursorResult ImplementNLMarkJoin(ClrDataCursorRelImplementor implementor, ClrEnumerablePrefer pref)
        {
            ...
            return implementor.Result(physType,
                Expression.Call(null,
                    ClrDataCursorBuiltInMethod.LeftMarkNestedLoopJoin.MakeGenericMethod(leftType, rightType, rowType),
                    leftResult.Expression,
        ...
        /// <param name="pref"></param>
        /// <returns></returns>
        ClrDataCursorResult ImplementNLJoin(ClrDataCursorRelImplementor implementor, ClrEnumerablePrefer pref)
        {
            var leftResult = implementor.VisitChild(this, 0, (ClrDataCursorRel)left, pref);
            var rightResult = implementor.VisitChild(this, 1, (ClrDataCursorRel)right, pref);
            var rightResultAsync = implementor.VisitChildAsync(this, 1, (ClrDataCursorRel)right, pref);
            ...
            return implementor.Result(physType,
                Expression.Call(null,
                    ClrDataCursorBuiltInMethod.NestedLoopJoin.MakeGenericMethod(leftType, rightType, rowType),
                    leftResult.Expression,
                    implementor.Opener(rightResult),
                    implementor.OpenerAsync(rightResultAsync),
                    selector,
