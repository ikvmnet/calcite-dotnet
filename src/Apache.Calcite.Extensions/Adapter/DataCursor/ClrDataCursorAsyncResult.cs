...
namespace Apache.Calcite.Extensions.Adapter.DataCursor
{
    ...
    /// </summary>
    /// <remarks>
    /// <see cref="ClrDataCursorResult"/>'s companion, and the return type of the awaiting fork:
    /// <see cref="ClrDataCursorRel.ImplementAsync"/> and
    /// <see cref="ClrDataCursorRelImplementor.VisitChildAsync"/> answer this, and the synchronous members
    /// answer the other. The expression's value is a <see cref="ValueTask{TResult}"/> of a
    /// <c>ClrDataCursor&lt;TRow&gt;</c>: the cursor is the same one the other fork opens, and what is awaited
    ...
    /// </remarks>
    public class ClrDataCursorAsyncResult
    {
        ...
        /// <remarks>
        /// Internal, so that <see cref="ClrDataCursorRelImplementor.ResultAsync"/> is the only way a node
        /// has of making one, exactly as for the synchronous result.
        /// </remarks>
        internal ClrDataCursorAsyncResult(Expression expression, ClrPhysType physType, JavaRowFormat format)
        {
        ...
        /// <c>ValueTask&lt;ClrDataCursor&lt;TRow&gt;&gt;</c>.
        /// </summary>
