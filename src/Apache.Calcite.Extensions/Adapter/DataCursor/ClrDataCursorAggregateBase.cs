...
namespace Apache.Calcite.Extensions.Adapter.DataCursor
{
    ...
    /// <summary>
    /// Base class for an aggregate of the <see cref="ClrDataCursorConvention"/> calling convention.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public abstract class ClrDataCursorAggregateBase : Aggregate
    {
        ...
        protected ClrDataCursorAggregateBase(RelOptCluster cluster, RelTraitSet traitSet, java.util.List hints, RelNode input, ImmutableBitSet groupSet, java.util.List groupSets, java.util.List aggCalls) :
