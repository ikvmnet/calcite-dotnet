...
namespace Apache.Calcite.Extensions.Adapter.DataCursor
{
    ...
    /// </remarks>
    public class ClrDataCursorMergeJoin : Join, ClrDataCursorRel
    {
        ...
        {
            return ClrDataCursorDefaults.IsMergeJoinSupported(ClrEnumUtils.ToLinq4jJoinType(joinType));
        }

        /// <summary>
        /// Creates a <see cref="ClrDataCursorMergeJoin"/>.
        /// </summary>
        ...
        /// <param name="joinType"></param>
        /// <returns></returns>
        public static ClrDataCursorMergeJoin Create(RelNode left, RelNode right, RexNode condition, ImmutableIntList leftKeys, ImmutableIntList rightKeys, JoinRelType joinType)
        {
            ...
            return new ClrDataCursorMergeJoin(cluster, traitSet, left, right, condition, com.google.common.collect.ImmutableSet.of(), joinType);
        }
        ...
        /// <param name="joinType"></param>
        public ClrDataCursorMergeJoin(RelOptCluster cluster, RelTraitSet traits, RelNode left, RelNode right, RexNode condition, java.util.Set variablesSet, JoinRelType joinType) :
            base(cluster, traits, com.google.common.collect.ImmutableList.of(), left, right, condition, variablesSet, joinType)
        {
            ...
            if (IsMergeJoinSupported(joinType) == false)
                throw new java.lang.UnsupportedOperationException($"ClrDataCursorMergeJoin unsupported for join type {joinType}");
        }
        ...
        {
            return new ClrDataCursorMergeJoin(getCluster(), traitSet, left, right, conditionExpr, getVariablesSet(), joinType);
        }
        ...
        public ClrDataCursorResult Implement(ClrDataCursorRelImplementor implementor, ClrEnumerablePrefer pref)
        {
            ...
            return implementor.Result(physType,
                Expression.Call(null,
                    ClrDataCursorBuiltInMethod.MergeJoin.MakeGenericMethod(leftType_, rightType_, leftKey.ReturnType, rowType),
        ...
        public ClrDataCursorAsyncResult ImplementAsync(ClrDataCursorRelImplementor implementor, ClrEnumerablePrefer pref)
        {
            ...
            return implementor.ResultAsync(physType,
                ClrDataCursorBuiltInMethod.CallAsync(implementor, ClrDataCursorBuiltInMethod.MergeJoinAsync.MakeGenericMethod(leftType_, rightType_, leftKey.ReturnType, rowType),
                    leftResult.Expression,
                    rightResult.Expression,
                    leftKey,
                    rightKey,
