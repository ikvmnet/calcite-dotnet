...
namespace Apache.Calcite.Extensions.Adapter.DataCursor
{
    ...
    /// <summary>
    /// Implementation of <see cref="TableSpool"/> in the <see cref="ClrDataCursorConvention"/> calling
    /// convention.
    /// </summary>
    /// <remarks>
    ...
    /// than once.</para>
    /// </remarks>
    public class ClrDataCursorTableSpool : TableSpool, ClrDataCursorRel
    {

        /// <summary>
        /// Creates a <see cref="ClrDataCursorTableSpool"/>.
        /// </summary>
        ...
        /// <returns></returns>
        public static ClrDataCursorTableSpool Create(RelNode input, Spool.Type readType, Spool.Type writeType, RelOptTable table)
        {
            ...
            return new ClrDataCursorTableSpool(cluster, traitSet, input, readType, writeType, table);
        }
        ...
        /// <param name="writeType"></param>
        /// <param name="table"></param>
        public ClrDataCursorTableSpool(RelOptCluster cluster, RelTraitSet traitSet, RelNode input, Spool.Type readType, Spool.Type writeType, RelOptTable table) :
        ...
        {
            return new ClrDataCursorTableSpool(getCluster(), traitSet, input, readType, writeType, getTable());
        }
        ...
        public ClrDataCursorResult Implement(ClrDataCursorRelImplementor implementor, ClrEnumerablePrefer pref)
        {
            ...
            var result = implementor.VisitChild(this, 0, (ClrDataCursorRel)getInput(), pref);
            ...
            return implementor.Result(physType,
                Expression.Call(null,
                    ClrDataCursorBuiltInMethod.LazyCollectionSpool.MakeGenericMethod(rowType),
                    collection,
                    result.Expression));
        }
        ...
        public ClrDataCursorAsyncResult ImplementAsync(ClrDataCursorRelImplementor implementor, ClrEnumerablePrefer pref)
        {
            ...
            var result = implementor.VisitChildAsync(this, 0, (ClrDataCursorRel)getInput(), pref);
            ...
            return implementor.ResultAsync(physType,
                ClrDataCursorBuiltInMethod.CallAsync(implementor, ClrDataCursorBuiltInMethod.LazyCollectionSpoolAsync.MakeGenericMethod(rowType),
                    collection,
                    result.Expression));
        }
