...
namespace Apache.Calcite.Extensions.Adapter.DataCursor
{
    ...
    /// <summary>
    /// Rule that converts a <see cref="LogicalAggregate"/> to a <see cref="ClrDataCursorSortedAggregate"/>.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public class ClrDataCursorSortedAggregateRule : ConverterRule
    {

        /// <summary>
        /// Creates a <see cref="ClrDataCursorSortedAggregateRule"/>.
        /// </summary>
        /// <returns></returns>
        public static ClrDataCursorSortedAggregateRule Create()
        {
            return (ClrDataCursorSortedAggregateRule)Config.INSTANCE
                .withConversion((java.lang.Class)typeof(LogicalAggregate), Convention.NONE, ClrDataCursorConvention.Instance, "ClrDataCursorSortedAggregateRule")
                .withRuleFactory(new DelegateFunction<Config, ClrDataCursorSortedAggregateRule>(c => new ClrDataCursorSortedAggregateRule(c)))
                .toRule(typeof(ClrDataCursorSortedAggregateRule));
        }
        ...
        public ClrDataCursorSortedAggregateRule(Config config) :
            base(config)
        {
        ...
        /// global aggregate has nothing to sort by and belongs to <see cref="ClrDataCursorAggregate"/>.
        /// </remarks>
        public override RelNode? convert(RelNode rel)
        {
            ...
            return new ClrDataCursorSortedAggregate(
                rel.getCluster(),
                selfTraits,
