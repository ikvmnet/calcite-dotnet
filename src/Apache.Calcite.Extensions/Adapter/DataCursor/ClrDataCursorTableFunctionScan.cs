...
namespace Apache.Calcite.Extensions.Adapter.DataCursor
{
    ...
    /// <summary>
    /// Implementation of <see cref="TableFunctionScan"/> in the <see cref="ClrDataCursorConvention"/> calling
    /// convention.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public class ClrDataCursorTableFunctionScan : TableFunctionScan, ClrDataCursorRel
    {
        ...
        public ClrDataCursorTableFunctionScan(
        ...
        {
            return new ClrDataCursorTableFunctionScan(getCluster(), traitSet, inputs, elementType, rowType, rexCall, columnMappings);
        }
        ...
        /// </remarks>
        ClrDataCursorResult TvfImplementorBasedImplement(ClrDataCursorRelImplementor implementor, ClrEnumerablePrefer pref)
        {
            var child = (ClrDataCursorRel)getInputs().get(0);
            ...
            return TvfImplementorBasedWindow(implementor, pref, result.PhysType, result.Format,
                Expression.Call(null,
                    ClrDataCursorBuiltInMethod.AsEnumerable.MakeGenericMethod(result.PhysType.RowType),
        ...
        /// nowhere to suspend.
        /// </remarks>
        ClrDataCursorAsyncResult TvfImplementorBasedImplementAsync(ClrDataCursorRelImplementor implementor, ClrEnumerablePrefer pref)
        {
            var child = (ClrDataCursorRel)getInputs().get(0);
        ...
        /// </remarks>
        ClrDataCursorResult TvfImplementorBasedWindow(ClrDataCursorRelImplementor implementor, ClrEnumerablePrefer pref, ClrPhysType inputPhysType, JavaRowFormat inputFormat, Expression pulled)
        {
            ...
            var source = Expression.Call(null, ClrDataCursorBuiltInMethod.ToJava.MakeGenericMethod(sourceType), pulled);
            ...
            return implementor.Result(physType,
                Expression.Call(null, ClrDataCursorBuiltInMethod.FromJava.MakeGenericMethod(rowType), windowed));
        }
        ...
        /// <param name="implementor"></param>
        /// <returns></returns>
        ClrDataCursorResult DefaultTableFunctionImplement(ClrDataCursorRelImplementor implementor)
        {
            var typeFactory = implementor.TypeFactory;
            ...
            return implementor.Result(physType,
                Expression.Call(null,
                    ClrDataCursorBuiltInMethod.FromJava.MakeGenericMethod(rowType),
                    implementor.Translator.TranslateBody(block.toBlock(), typeof(org.apache.calcite.linq4j.Enumerable))));
        }
