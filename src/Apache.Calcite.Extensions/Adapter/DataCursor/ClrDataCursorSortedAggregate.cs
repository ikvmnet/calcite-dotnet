...
namespace Apache.Calcite.Extensions.Adapter.DataCursor
{
    ...
    /// <see cref="ClrDataCursorAggregate"/> does not — everything shared is on
    /// <see cref="ClrDataCursorAggregateBase"/>.
    /// </remarks>
    public class ClrDataCursorSortedAggregate : ClrDataCursorAggregateBase, ClrDataCursorRel
    {
        ...
        public ClrDataCursorSortedAggregate(RelOptCluster cluster, RelTraitSet traitSet, RelNode input, ImmutableBitSet groupSet, java.util.List groupSets, java.util.List aggCalls) :
        ...
        {
            return new ClrDataCursorSortedAggregate(getCluster(), traitSet, input, groupSet, groupSets, aggCalls);
        }
        ...
        {
            if (isSimple(this) == false)
                throw new java.lang.UnsupportedOperationException("ClrDataCursorSortedAggregate: grouping sets");
            ...
            return implementor.Result(physType,
                Expression.Call(null,
                    ClrDataCursorBuiltInMethod.SortedGroupBy.MakeGenericMethod(sourceType, keySelector.ReturnType, rowType),
                    result.Expression,
                    keySelector,
        ...
        public ClrDataCursorAsyncResult ImplementAsync(ClrDataCursorRelImplementor implementor, ClrEnumerablePrefer pref)
        {
            ...
            return implementor.ResultAsync(physType,
                ClrDataCursorBuiltInMethod.CallAsync(implementor, ClrDataCursorBuiltInMethod.SortedGroupByAsync.MakeGenericMethod(sourceType, keySelector.ReturnType, rowType),
                    result.Expression,
                    keySelector,
                    Expression.Call(lambdaFactory, AccInitializer),
                    Expression.Call(lambdaFactory, AccAdder),
