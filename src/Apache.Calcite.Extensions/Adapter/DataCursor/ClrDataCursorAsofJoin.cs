...
namespace Apache.Calcite.Extensions.Adapter.DataCursor
{
    ...
    /// <summary>
    /// Implementation of <see cref="AsofJoin"/> in the <see cref="ClrDataCursorConvention"/> calling
    /// convention.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public class ClrDataCursorAsofJoin : AsofJoin, ClrDataCursorRel
    {

        /// <summary>
        /// Creates a <see cref="ClrDataCursorAsofJoin"/>.
        /// </summary>
        ...
        /// <returns></returns>
        public static ClrDataCursorAsofJoin Create(RelNode left, RelNode right, RexNode condition, RexNode matchCondition, java.util.Set variablesSet, JoinRelType joinType)
        {
            ...
            return new ClrDataCursorAsofJoin(cluster, traitSet, left, right, condition, matchCondition, variablesSet, joinType);
        }
        ...
        /// <param name="variablesSet"></param>
        /// <param name="joinType"></param>
        public ClrDataCursorAsofJoin(RelOptCluster cluster, RelTraitSet traits, RelNode left, RelNode right, RexNode condition, RexNode matchCondition, java.util.Set variablesSet, JoinRelType joinType) :
        ...
        {
            return new ClrDataCursorAsofJoin(
                getCluster(),
                traitSet,
        ...
        public ClrDataCursorResult Implement(ClrDataCursorRelImplementor implementor, ClrEnumerablePrefer pref)
        {
            ...
            return implementor.Result(physType,
                Expression.Call(null,
                    ClrDataCursorBuiltInMethod.AsofJoin.MakeGenericMethod(leftType, rightType, leftKey.ReturnType, rowType),
        ...
        public ClrDataCursorAsyncResult ImplementAsync(ClrDataCursorRelImplementor implementor, ClrEnumerablePrefer pref)
        {
            ...
            return implementor.ResultAsync(physType,
                ClrDataCursorBuiltInMethod.CallAsync(implementor, ClrDataCursorBuiltInMethod.AsofJoinAsync.MakeGenericMethod(leftType, rightType, leftKey.ReturnType, rowType),
                    leftResult.Expression,
