...
namespace Apache.Calcite.Extensions.Adapter.DataCursor
{
    ...
    /// </remarks>
    public class ClrDataCursorHashJoin : Join, ClrDataCursorRel
    {

        /// <summary>
        /// Creates a <see cref="ClrDataCursorHashJoin"/>.
        /// </summary>
        ...
        /// <returns></returns>
        public static ClrDataCursorHashJoin Create(RelNode left, RelNode right, RexNode condition, java.util.Set variablesSet, JoinRelType joinType)
        {
            ...
            return new ClrDataCursorHashJoin(cluster, traitSet, left, right, condition, variablesSet, joinType);
        }
        ...
        /// <param name="variablesSet"></param>
        /// <param name="joinType"></param>
        public ClrDataCursorHashJoin(RelOptCluster cluster, RelTraitSet traits, RelNode left, RelNode right, RexNode condition, java.util.Set variablesSet, JoinRelType joinType) :
        ...
        {
            return new ClrDataCursorHashJoin(getCluster(), traitSet, left, right, conditionExpr, getVariablesSet(), joinType);
        }
        ...
        /// </remarks>
        ClrDataCursorAsyncResult ImplementHashSemiJoinAsync(ClrDataCursorRelImplementor implementor, ClrEnumerablePrefer pref)
        {
            var leftResult = implementor.VisitChildAsync(this, 0, (ClrDataCursorRel)left, pref);
            var rightResult = implementor.VisitChildAsync(this, 1, (ClrDataCursorRel)right, pref);
            var rightResultSync = implementor.VisitChild(this, 1, (ClrDataCursorRel)right, pref);
            ...
            return implementor.ResultAsync(physType,
                ClrDataCursorBuiltInMethod.CallAsync(implementor, ClrDataCursorBuiltInMethod.SemiJoinAsync.MakeGenericMethod(leftType, rightType, leftKey.ReturnType),
        ...
        /// </remarks>
        ClrDataCursorAsyncResult ImplementHashMarkJoinAsync(ClrDataCursorRelImplementor implementor, ClrEnumerablePrefer pref)
        {
            var leftResult = implementor.VisitChildAsync(this, 0, (ClrDataCursorRel)left, pref);
            var rightResult = implementor.VisitChildAsync(this, 1, (ClrDataCursorRel)right, pref);
            ...
            return implementor.ResultAsync(physType,
                ClrDataCursorBuiltInMethod.CallAsync(implementor, ClrDataCursorBuiltInMethod.LeftMarkHashJoinAsync.MakeGenericMethod(leftType, rightType, keyType, nullSafeKeyType, rowType),
                    leftResult.Expression,
        ...
        /// <param name="pref"></param>
        /// <returns></returns>
        ClrDataCursorAsyncResult ImplementHashJoinAsync(ClrDataCursorRelImplementor implementor, ClrEnumerablePrefer pref)
        {
            var leftResult = implementor.VisitChildAsync(this, 0, (ClrDataCursorRel)left, pref);
            var rightResult = implementor.VisitChildAsync(this, 1, (ClrDataCursorRel)right, pref);
            ...
            return implementor.ResultAsync(physType,
                ClrDataCursorBuiltInMethod.CallAsync(implementor, ClrDataCursorBuiltInMethod.HashJoinAsync.MakeGenericMethod(leftType, rightType, keyType, rowType),
                    leftResult.Expression,
                    rightResult.Expression,
                    leftKey,
                    rightKey,
        ...
        /// <param name="pref"></param>
        /// <returns></returns>
        ClrDataCursorResult ImplementHashJoin(ClrDataCursorRelImplementor implementor, ClrEnumerablePrefer pref)
        {
            var leftResult = implementor.VisitChild(this, 0, (ClrDataCursorRel)left, pref);
            var rightResult = implementor.VisitChild(this, 1, (ClrDataCursorRel)right, pref);
            ...
            return implementor.Result(physType,
                Expression.Call(null,
                    ClrDataCursorBuiltInMethod.HashJoin.MakeGenericMethod(leftType, rightType, keyType, rowType),
                    leftResult.Expression,
                    rightResult.Expression,
                    leftKey,
                    rightKey,
        ...
        /// operator as openers of both kinds, and this body visits it through the other hierarchy too.
        /// </remarks>
        ClrDataCursorResult ImplementHashSemiJoin(ClrDataCursorRelImplementor implementor, ClrEnumerablePrefer pref)
        {
            var leftResult = implementor.VisitChild(this, 0, (ClrDataCursorRel)left, pref);
            var rightResult = implementor.VisitChild(this, 1, (ClrDataCursorRel)right, pref);
            var rightResultAsync = implementor.VisitChildAsync(this, 1, (ClrDataCursorRel)right, pref);
            ...
            return implementor.Result(physType,
                Expression.Call(null,
                    ClrDataCursorBuiltInMethod.SemiJoin.MakeGenericMethod(leftType, rightType, leftKey.ReturnType),
                    leftResult.Expression,
        ...
        /// hash lookup alone can decide.</para>
        /// </remarks>
        ClrDataCursorResult ImplementHashMarkJoin(ClrDataCursorRelImplementor implementor, ClrEnumerablePrefer pref)
        {
            var leftResult = implementor.VisitChild(this, 0, (ClrDataCursorRel)left, pref);
            var rightResult = implementor.VisitChild(this, 1, (ClrDataCursorRel)right, pref);
            ...
            return implementor.Result(physType,
                Expression.Call(null,
                    ClrDataCursorBuiltInMethod.LeftMarkHashJoin.MakeGenericMethod(leftType, rightType, keyType, nullSafeKeyType, rowType),
                    leftResult.Expression,
                    rightResult.Expression,
                    leftKeySelector,
                    rightKeySelector,
        ...
        /// <returns></returns>
        Expression Predicate(ClrDataCursorRelImplementor implementor, ClrPhysType leftPhysType, ClrPhysType rightPhysType, Type leftType, Type rightType)
        {
