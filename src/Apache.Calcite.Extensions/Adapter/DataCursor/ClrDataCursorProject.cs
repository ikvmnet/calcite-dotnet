...
namespace Apache.Calcite.Extensions.Adapter.DataCursor
{
    ...
    /// <summary>
    /// Implementation of <see cref="Project"/> in the <see cref="ClrDataCursorConvention"/> calling convention.
    /// </summary>
    public class ClrDataCursorProject : Project, ClrDataCursorRel
    {

        /// <summary>
        /// Creates a <see cref="ClrDataCursorProject"/>.
        /// </summary>
        /// <param name="input"></param>
        /// <param name="projects"></param>
        /// <param name="rowType"></param>
        /// <returns></returns>
        public static ClrDataCursorProject Create(RelNode input, java.util.List projects, RelDataType rowType)
        {
            ...
            return new ClrDataCursorProject(cluster, traitSet, input, projects, rowType);
        }
        ...
        /// <param name="projects"></param>
        /// <param name="rowType"></param>
        public ClrDataCursorProject(RelOptCluster cluster, RelTraitSet traitSet, RelNode input, java.util.List projects, RelDataType rowType) :
        ...
        {
            return new ClrDataCursorProject(getCluster(), traitSet, input, projects, rowType);
        }
        ...
        public ClrDataCursorResult Implement(ClrDataCursorRelImplementor implementor, ClrEnumerablePrefer pref)
        {
            throw new java.lang.UnsupportedOperationException(
                "ClrDataCursorProject cannot implement itself, exactly as EnumerableProject cannot: a calc " +
