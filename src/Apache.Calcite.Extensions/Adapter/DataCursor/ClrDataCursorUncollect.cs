...
namespace Apache.Calcite.Extensions.Adapter.DataCursor
{
    ...
    /// <summary>
    /// Implementation of <see cref="Uncollect"/> in the <see cref="ClrDataCursorConvention"/> calling
    /// convention.
    /// </summary>
    /// <remarks>
    /// Turns each row holding a collection into a row per element, which is what UNNEST becomes.
    /// </remarks>
    public class ClrDataCursorUncollect : Uncollect, ClrDataCursorRel
    {

        /// <summary>
        /// Creates a <see cref="ClrDataCursorUncollect"/>. Each field of the input must be an array or a
        ...
        /// <returns></returns>
        public static ClrDataCursorUncollect Create(RelTraitSet traitSet, RelNode input, bool withOrdinality)
        {
            return Create(traitSet, input, withOrdinality, true, false);
        }

        /// <summary>
        /// Creates a <see cref="ClrDataCursorUncollect"/>.
        /// </summary>
        /// <param name="traitSet"></param>
        /// <param name="input"></param>
        /// <param name="withOrdinality">whether the output carries an ORDINALITY column</param>
        ...
        /// <returns></returns>
        public static ClrDataCursorUncollect Create(RelTraitSet traitSet, RelNode input, bool withOrdinality, bool expandStructFields, bool isOuter)
        {
            return new ClrDataCursorUncollect(input.getCluster(), traitSet, input, withOrdinality, com.google.common.collect.ImmutableList.of(), expandStructFields, isOuter);
        }
        ...
        /// </remarks>
        public ClrDataCursorUncollect(RelOptCluster cluster, RelTraitSet traitSet, RelNode input, bool withOrdinality, java.util.List itemAliases) :
        ...
        public ClrDataCursorUncollect(RelOptCluster cluster, RelTraitSet traitSet, RelNode input, bool withOrdinality, java.util.List itemAliases, bool expandStructFields, bool isOuter) :
        ...
        {
            return new ClrDataCursorUncollect(getCluster(), traitSet, input, withOrdinality, com.google.common.collect.ImmutableList.of(), expandStructFields, isOuter);
        }
        ...
        public ClrDataCursorResult Implement(ClrDataCursorRelImplementor implementor, ClrEnumerablePrefer pref)
        {
            ...
            return implementor.Result(physType,
                Expression.Call(null,
                    ClrDataCursorBuiltInMethod.SelectMany.MakeGenericMethod(sourceType, rowType),
                    result.Expression,
        ...
        public ClrDataCursorAsyncResult ImplementAsync(ClrDataCursorRelImplementor implementor, ClrEnumerablePrefer pref)
        {
            ...
            return implementor.ResultAsync(physType,
                ClrDataCursorBuiltInMethod.CallAsync(implementor, ClrDataCursorBuiltInMethod.SelectManyAsync.MakeGenericMethod(sourceType, rowType),
                    result.Expression,
                    ClrEnumUtils.Convert(implementor.Translator.Translate(lambda), typeof(org.apache.calcite.linq4j.function.Function1))));
        }
