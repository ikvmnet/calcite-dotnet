...
namespace Apache.Calcite.Extensions.Adapter.DataCursor
{
    ...
    /// <summary>
    /// Implementation of <see cref="Values"/> in the <see cref="ClrDataCursorConvention"/> calling convention.
    /// </summary>
    public class ClrDataCursorValues : Values, ClrDataCursorRel
    {

        /// <summary>
        /// Creates a <see cref="ClrDataCursorValues"/>.
        /// </summary>
        /// <param name="cluster"></param>
        /// <param name="rowType"></param>
        /// <param name="tuples"></param>
        /// <returns></returns>
        public static ClrDataCursorValues Create(RelOptCluster cluster, RelDataType rowType, com.google.common.collect.ImmutableList tuples)
        {
            ...
            return new ClrDataCursorValues(cluster, rowType, tuples, traitSet);
        }
        ...
        public ClrDataCursorValues(RelOptCluster cluster, RelDataType rowType, com.google.common.collect.ImmutableList tuples, RelTraitSet traitSet) :
        ...
        {
            return new ClrDataCursorValues(getCluster(), getRowType(), tuples, traitSet);
        }
        ...
        public ClrDataCursorResult Implement(ClrDataCursorRelImplementor implementor, ClrEnumerablePrefer pref)
        {
            ...
            return implementor.Result(physType,
                Expression.Call(null,
                    ClrDataCursorBuiltInMethod.AsCursorArray.MakeGenericMethod(rowType),
        ...
        public ClrDataCursorAsyncResult ImplementAsync(ClrDataCursorRelImplementor implementor, ClrEnumerablePrefer pref)
        {
            ...
            return implementor.ResultAsync(physType,
                ClrDataCursorBuiltInMethod.CallAsync(implementor, ClrDataCursorBuiltInMethod.AsCursorArrayAsync.MakeGenericMethod(rowType),
                    Expression.NewArrayInit(rowType, rows)));
        }
