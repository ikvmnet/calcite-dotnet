...
namespace Apache.Calcite.Extensions.Adapter.Enumerable
{
    ...
    /// aggregate is on <see cref="ClrEnumerableAggregateBase"/>, exactly as Calcite splits the two.</para>
    /// </remarks>
    public class ClrEnumerableAggregate : ClrEnumerableAggregateBase, ClrEnumerableRel
    {
