...
namespace Apache.Calcite.Extensions.Adapter.Cursor
{
    ...
    /// <c>EnumerableToClrCursorConverter</c> — one more convention boundary for the same rows.</para>
    ///
    ...
    /// <see cref="ClrCursorRel.ImplementAsync"/> — the synchronous open, completed — is the honest
