...
namespace Apache.Calcite.Extensions.Adapter.AsyncEnumerable
{
    ...
    /// <summary>
    /// Implementation of <see cref="Uncollect"/> in the <see cref="ClrAsyncEnumerableConvention"/> calling
    /// convention.
    /// </summary>
    /// <remarks>
    /// Turns each row holding a collection into a row per element, which is what UNNEST becomes.
    /// </remarks>
    public class ClrAsyncEnumerableUncollect : Uncollect, ClrAsyncEnumerableRel
    {
        ...
        /// <returns></returns>
        public static ClrAsyncEnumerableUncollect Create(RelTraitSet traitSet, RelNode input, bool withOrdinality)
        {
            return new ClrAsyncEnumerableUncollect(input.getCluster(), traitSet, input, withOrdinality, com.google.common.collect.ImmutableList.of());
        }
        ...
        public ClrAsyncEnumerableUncollect(RelOptCluster cluster, RelTraitSet traitSet, RelNode input, bool withOrdinality, java.util.List itemAliases) :
        ...
        {
            return new ClrAsyncEnumerableUncollect(getCluster(), traitSet, input, withOrdinality, com.google.common.collect.ImmutableList.of());
        }
