...
namespace Apache.Calcite.Extensions.Adapter.AsyncEnumerable
{
    ...
    /// </remarks>
    public class ClrAsyncEnumerableMergeJoin : Join, ClrAsyncEnumerableRel
    {
        ...
        {
            return ClrAsyncEnumerableDefaults.IsMergeJoinSupported(ClrEnumUtils.ToLinq4jJoinType(joinType));
        }

        /// <summary>
        /// Creates a <see cref="ClrAsyncEnumerableMergeJoin"/>.
        /// </summary>
        ...
        /// <param name="joinType"></param>
        /// <returns></returns>
        public static ClrAsyncEnumerableMergeJoin Create(RelNode left, RelNode right, RexNode condition, ImmutableIntList leftKeys, ImmutableIntList rightKeys, JoinRelType joinType)
        {
            ...
            return new ClrAsyncEnumerableMergeJoin(cluster, traitSet, left, right, condition, com.google.common.collect.ImmutableSet.of(), joinType);
        }
        ...
        /// <param name="joinType"></param>
        public ClrAsyncEnumerableMergeJoin(RelOptCluster cluster, RelTraitSet traits, RelNode left, RelNode right, RexNode condition, java.util.Set variablesSet, JoinRelType joinType) :
            base(cluster, traits, com.google.common.collect.ImmutableList.of(), left, right, condition, variablesSet, joinType)
        {
            ...
            if (IsMergeJoinSupported(joinType) == false)
                throw new java.lang.UnsupportedOperationException($"ClrAsyncEnumerableMergeJoin unsupported for join type {joinType}");
        }
        ...
        {
            return new ClrAsyncEnumerableMergeJoin(getCluster(), traitSet, left, right, conditionExpr, getVariablesSet(), joinType);
        }
        ...
        public ClrAsyncEnumerableResult Implement(ClrAsyncEnumerableRelImplementor implementor, ClrEnumerablePrefer pref)
        {
            ...
            return implementor.Result(physType,
                ClrAsyncBuiltInMethod.Call(ClrAsyncBuiltInMethod.MergeJoin.MakeGenericMethod(leftType_, rightType_, leftKey.ReturnType, rowType),
