...
namespace Apache.Calcite.Extensions.Adapter.AsyncEnumerable
{
    ...
    /// <summary>
    /// Implementation of <see cref="Project"/> in the <see cref="ClrAsyncEnumerableConvention"/> calling convention.
    /// </summary>
    public class ClrAsyncEnumerableProject : Project, ClrAsyncEnumerableRel
    {

        /// <summary>
        /// Creates a <see cref="ClrAsyncEnumerableProject"/>.
        /// </summary>
        /// <param name="input"></param>
        /// <param name="projects"></param>
        /// <param name="rowType"></param>
        /// <returns></returns>
        public static ClrAsyncEnumerableProject Create(RelNode input, java.util.List projects, RelDataType rowType)
        {
            ...
            return new ClrAsyncEnumerableProject(cluster, traitSet, input, projects, rowType);
        }
        ...
        /// <param name="projects"></param>
        /// <param name="rowType"></param>
        public ClrAsyncEnumerableProject(RelOptCluster cluster, RelTraitSet traitSet, RelNode input, java.util.List projects, RelDataType rowType) :
        ...
        {
            return new ClrAsyncEnumerableProject(getCluster(), traitSet, input, projects, rowType);
        }
