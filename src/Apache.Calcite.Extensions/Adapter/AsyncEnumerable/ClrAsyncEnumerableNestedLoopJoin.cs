...
namespace Apache.Calcite.Extensions.Adapter.AsyncEnumerable
{
    ...
    /// <see cref="ClrAsyncEnumerableHashJoin"/> leaves for it.
    /// </remarks>
    public class ClrAsyncEnumerableNestedLoopJoin : Join, ClrAsyncEnumerableRel
    {

        /// <summary>
        /// Creates a <see cref="ClrAsyncEnumerableNestedLoopJoin"/>.
        /// </summary>
        ...
        /// <returns></returns>
        public static ClrAsyncEnumerableNestedLoopJoin Create(RelNode left, RelNode right, RexNode condition, java.util.Set variablesSet, JoinRelType joinType)
        {
            ...
            return new ClrAsyncEnumerableNestedLoopJoin(cluster, traitSet, left, right, condition, variablesSet, joinType);
        }
        ...
        /// <param name="variablesSet"></param>
        /// <param name="joinType"></param>
        public ClrAsyncEnumerableNestedLoopJoin(RelOptCluster cluster, RelTraitSet traits, RelNode left, RelNode right, RexNode condition, java.util.Set variablesSet, JoinRelType joinType) :
        ...
        {
            return new ClrAsyncEnumerableNestedLoopJoin(getCluster(), traitSet, left, right, conditionExpr, getVariablesSet(), joinType);
        }
        ...
        /// </remarks>
        ClrAsyncEnumerableResult ImplementNLMarkJoin(ClrAsyncEnumerableRelImplementor implementor, ClrEnumerablePrefer pref)
        {
            ...
            return implementor.Result(physType,
                ClrAsyncBuiltInMethod.Call(ClrAsyncBuiltInMethod.LeftMarkNestedLoopJoin.MakeGenericMethod(leftType, rightType, rowType),
        ...
        /// <param name="pref"></param>
        /// <returns></returns>
        ClrAsyncEnumerableResult ImplementNLJoin(ClrAsyncEnumerableRelImplementor implementor, ClrEnumerablePrefer pref)
        {
            var leftResult = implementor.VisitChild(this, 0, (ClrAsyncEnumerableRel)left, pref);
            var rightResult = implementor.VisitChild(this, 1, (ClrAsyncEnumerableRel)right, pref);
            ...
            return implementor.Result(physType,
                ClrAsyncBuiltInMethod.Call(ClrAsyncBuiltInMethod.NestedLoopJoin.MakeGenericMethod(leftType, rightType, rowType),
                    leftResult.Expression,
                    rightResult.Expression,
                    selector,
                    predicate,
