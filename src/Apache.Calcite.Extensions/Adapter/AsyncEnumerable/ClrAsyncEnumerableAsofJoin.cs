...
namespace Apache.Calcite.Extensions.Adapter.AsyncEnumerable
{
    ...
    /// <summary>
    /// Implementation of <see cref="AsofJoin"/> in the <see cref="ClrAsyncEnumerableConvention"/> calling
    /// convention.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public class ClrAsyncEnumerableAsofJoin : AsofJoin, ClrAsyncEnumerableRel
    {

        /// <summary>
        /// Creates a <see cref="ClrAsyncEnumerableAsofJoin"/>.
        /// </summary>
        ...
        /// <returns></returns>
        public static ClrAsyncEnumerableAsofJoin Create(RelNode left, RelNode right, RexNode condition, RexNode matchCondition, java.util.Set variablesSet, JoinRelType joinType)
        {
            ...
            return new ClrAsyncEnumerableAsofJoin(cluster, traitSet, left, right, condition, matchCondition, variablesSet, joinType);
        }
        ...
        /// <param name="variablesSet"></param>
        /// <param name="joinType"></param>
        public ClrAsyncEnumerableAsofJoin(RelOptCluster cluster, RelTraitSet traits, RelNode left, RelNode right, RexNode condition, RexNode matchCondition, java.util.Set variablesSet, JoinRelType joinType) :
        ...
        {
            return new ClrAsyncEnumerableAsofJoin(
                getCluster(),
                traitSet,
        ...
        public ClrAsyncEnumerableResult Implement(ClrAsyncEnumerableRelImplementor implementor, ClrEnumerablePrefer pref)
        {
            ...
            return implementor.Result(physType,
                ClrAsyncBuiltInMethod.Call(ClrAsyncBuiltInMethod.AsofJoin.MakeGenericMethod(leftType, rightType, leftKey.ReturnType, rowType),
