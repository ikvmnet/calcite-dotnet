...
namespace Apache.Calcite.Extensions.Adapter.AsyncEnumerable
{
    ...
    /// <summary>
    /// Base class for an aggregate of the <see cref="ClrAsyncEnumerableConvention"/> calling convention.
    /// </summary>
    /// <remarks>
    ...
    /// <see cref="ClrAsyncEnumerableWindow"/> needs two of them and is not an aggregate. Calcite's window declares
    ...
    /// </remarks>
    public abstract class ClrAsyncEnumerableAggregateBase : Aggregate
    {
        ...
        protected ClrAsyncEnumerableAggregateBase(RelOptCluster cluster, RelTraitSet traitSet, java.util.List hints, RelNode input, ImmutableBitSet groupSet, java.util.List groupSets, java.util.List aggCalls) :
