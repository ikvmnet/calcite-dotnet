...
namespace Apache.Calcite.Extensions.Adapter.AsyncEnumerable
{
    ...
    /// </summary>
    public class ClrAsyncEnumerableLimit : SingleRel, ClrAsyncEnumerableRel
    {

        /// <summary>
        /// Creates a <see cref="ClrAsyncEnumerableLimit"/>.
        /// </summary>
        /// <param name="input"></param>
        /// <param name="offset"></param>
        /// <param name="fetch"></param>
        /// <returns></returns>
        public static ClrAsyncEnumerableLimit Create(RelNode input, RexNode? offset, RexNode? fetch)
        {
            ...
            return new ClrAsyncEnumerableLimit(cluster, traitSet, input, offset, fetch);
        }
        ...
        /// <param name="offset"></param>
        /// <param name="fetch"></param>
        public ClrAsyncEnumerableLimit(RelOptCluster cluster, RelTraitSet traitSet, RelNode input, RexNode? offset, RexNode? fetch) :
        ...
        {
            return new ClrAsyncEnumerableLimit(getCluster(), traitSet, (RelNode)sole(newInputs), offset, fetch);
        }
        ...
        public ClrAsyncEnumerableResult Implement(ClrAsyncEnumerableRelImplementor implementor, ClrEnumerablePrefer pref)
        {
            ...
            if (offset != null)
                v = ClrAsyncBuiltInMethod.Call(ClrAsyncBuiltInMethod.Skip.MakeGenericMethod(rowType), v, Count(implementor, offset));

            if (fetch != null)
                v = ClrAsyncBuiltInMethod.Call(ClrAsyncBuiltInMethod.Take.MakeGenericMethod(rowType), v, Count(implementor, fetch));
        ...
        /// </remarks>
        internal static Expression Count(ClrAsyncEnumerableRelImplementor implementor, RexNode rexNode)
        {
