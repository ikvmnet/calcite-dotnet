...
namespace Apache.Calcite.Extensions.Adapter.AsyncEnumerable
{
    ...
    /// <summary>
    /// Implementation of <see cref="RepeatUnion"/> in the <see cref="ClrAsyncEnumerableConvention"/> calling
    /// convention.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public class ClrAsyncEnumerableRepeatUnion : RepeatUnion, ClrAsyncEnumerableRel
    {
        ...
        public ClrAsyncEnumerableRepeatUnion(RelOptCluster cluster, RelTraitSet traitSet, RelNode seed, RelNode iterative, bool all, int iterationLimit, RelOptTable transientTable) :
        ...
        {
            return new ClrAsyncEnumerableRepeatUnion(getCluster(), traitSet, (RelNode)inputs.get(0), (RelNode)inputs.get(1), all, iterationLimit, getTransientTable());
        }
        ...
        public ClrAsyncEnumerableResult Implement(ClrAsyncEnumerableRelImplementor implementor, ClrEnumerablePrefer pref)
        {
            ...
            var seedResult = implementor.VisitChild(this, 0, (ClrAsyncEnumerableRel)getSeedRel(), pref);
            var iterationResult = implementor.VisitChild(this, 1, (ClrAsyncEnumerableRel)getIterativeRel(), pref);
            ...
            body.Add(
                ClrAsyncBuiltInMethod.Call(ClrAsyncBuiltInMethod.RepeatUnion.MakeGenericMethod(rowType),
