...
namespace Apache.Calcite.Extensions.Adapter.AsyncEnumerable
{
    ...
    /// <see cref="ClrAsyncEnumerableAggregate"/> does not — everything shared is on
    /// <see cref="ClrAsyncEnumerableAggregateBase"/>.
    /// </remarks>
    public class ClrAsyncEnumerableSortedAggregate : ClrAsyncEnumerableAggregateBase, ClrAsyncEnumerableRel
    {
        ...
        public ClrAsyncEnumerableSortedAggregate(RelOptCluster cluster, RelTraitSet traitSet, RelNode input, ImmutableBitSet groupSet, java.util.List groupSets, java.util.List aggCalls) :
        ...
        {
            return new ClrAsyncEnumerableSortedAggregate(getCluster(), traitSet, input, groupSet, groupSets, aggCalls);
        }
        ...
        {
            if (isSimple(this) == false)
                throw new java.lang.UnsupportedOperationException("ClrAsyncEnumerableSortedAggregate: grouping sets");
            ...
            return implementor.Result(physType,
                ClrAsyncBuiltInMethod.Call(ClrAsyncBuiltInMethod.SortedGroupBy.MakeGenericMethod(sourceType, keySelector.ReturnType, rowType),
                    result.Expression,
                    keySelector,
