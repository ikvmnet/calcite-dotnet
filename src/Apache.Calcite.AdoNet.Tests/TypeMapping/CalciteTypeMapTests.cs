...
namespace Apache.Calcite.AdoNet.Tests.TypeMapping
{
    ...
    public class CalciteTypeMapTests
    {
        ...
        static readonly Type _mapType = typeof(Apache.Calcite.AdoNet.CalciteConnection).Assembly
            .GetType("Apache.Calcite.AdoNet.TypeMapping.CalciteTypeMap", throwOnError: true)!;
