...
namespace Apache.Calcite.Extensions.Adapter.DataCursor.Tests
{
    ...
    /// <summary>
    /// The parts of <see cref="ClrDataCursorWindow"/> a plan does not reach.
    /// </summary>
    /// <remarks>
    ...
    /// constants survived.
    /// </remarks>
    public class ClrDataCursorWindowTests
    {
        ...
        public void ShouldKeepTheConstantsItIsGivenWhenCopied()
        {
            ...
            var original = new ClrDataCursorWindow(cluster, traitSet, input, constants, rowType, com.google.common.collect.ImmutableList.of());
