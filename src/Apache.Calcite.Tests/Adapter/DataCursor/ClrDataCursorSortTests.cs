...
namespace Apache.Calcite.Extensions.Adapter.DataCursor.Tests
{
    ...
    /// </remarks>
    public class ClrDataCursorSortTests
    {
        ...
        public void ShouldPlanAMergeJoinOverSortedTableFunctionsInBothConventions()
        {
            ...
            {
                var plan = ClrDataCursorConventionDifferentialTests.PlanOfFib(Sql, clr, true);
        ...
        {
            var act = () => ClrDataCursorConventionDifferentialTests.RunFib(Sql, false, true);
        ...
        {
            var act = () => ClrDataCursorConventionDifferentialTests.RunFib(Sql, true, true);

            act.Should().Throw<java.lang.IllegalStateException>()
                .WithInnerException<java.lang.IllegalStateException>()
                .WithMessage("*ClrDataCursorSort handed up an open of System.Object[] where its row type is java.lang.Long*");
        }
