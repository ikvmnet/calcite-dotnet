...
namespace Apache.Calcite.Extensions.Adapter.DataCursor.Tests
{
    ...
    /// </remarks>
    public class ClrDataCursorConventionAdoNetTests
    {
        ...
        public async Task ShouldExplainAnAsyncPlanAsynchronously()
        {
            ...
            using (c)
            {
                ...
                reader.GetString(0).Should().Contain("ClrDataCursor");
        ...
        public async Task ShouldExplainTheSamePlanFromEitherOpen()
        {
            ...
            opened.Should().Contain("ClrDataCursor").And.NotContain("ClrEnumerableCalc", "a filter over a scan is the cursor convention's own");
        ...
        public async Task ShouldExplainThroughExecuteScalar()
        {
            ...
            cmd.ExecuteScalar().Should().BeOfType<string>()
                .Which.Should().Contain("ClrDataCursor");
