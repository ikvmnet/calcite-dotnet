...
namespace Apache.Calcite.Extensions.Adapter.DataCursor.Tests
{
    ...
    /// </summary>
    /// <remarks>
    /// The same oracle as <see cref="ClrDataCursorConventionDifferentialTests"/>, for the plans that cannot be written
    ...
    /// </remarks>
    public class ClrDataCursorConventionRelTests
    {
        ...
        public void ShouldAgreeOnCombiningTwoQueries() =>
            ClrDataCursorConventionDifferentialTests.SameRel(builder =>
            {
        ...
        public void ShouldAgreeOnCoalesce() =>
            ClrDataCursorConventionDifferentialTests.SameRel(builder => builder
                .scan("HR", "emps")
        ...
        public void ShouldAgreeOnAMergeUnionOverTwoCollations() =>
            ClrDataCursorConventionDifferentialTests.SameRel(b =>
            {
