...
namespace Apache.Calcite.Extensions.Adapter.Cursor.Tests
{
    ...
    public class ClrCursorConventionCancellationTests
    {
        ...
        static ClrCursorConventionCancellationTests()
        {
        ...
        static (ClrCursorFactory Factory, DataContext Context, AsyncRowsTable Leaf) PlanAny(string sql, int rowCount)
        {
            return Plan(sql, "ANYS", new AsyncRowsTable(ManyAnys(rowCount), AsyncTestRows.AnysRowType, false));
        }

        static (ClrCursorFactory Factory, DataContext Context, AsyncRowsTable Leaf) Plan(string sql, int rowCount)
        {
            return Plan(sql, "SORTED", new AsyncRowsTable(Many(rowCount), AsyncTestRows.SortedRowType, false));
        }

        static (ClrCursorFactory Factory, DataContext Context, AsyncRowsTable Leaf) Plan(string sql, string name, AsyncRowsTable leaf)
        {
