...
namespace Apache.Calcite.Extensions.Adapter.Enumerable.Tests
{
    ...
    /// <see cref="ClrEnumerableConventionDifferentialTests"/>, so agreeing with it is agreeing with Calcite. It is also
    ...
    /// </remarks>
    public class ClrEnumerableConventionAsyncDifferentialTests
    {

        /// <summary>
        /// Initializes the static instance.
        /// </summary>
        static ClrEnumerableConventionAsyncDifferentialTests()
        {
        ...
        /// <returns></returns>
        /// <remarks>
        /// <c>ClrEnumerableConventionDifferentialTests.RunRel</c> for this convention: the same planning, and the rule
        ...
        // gets these from Calcite — ClrAnyAggImplementors says why and ClrEnumerableConventionDifferentialTests asserts
        ...
        // Comparable. See ClrEnumerableConventionDifferentialTests.ShouldAgreeOnARollupOverEveryColumn.
        ...
        // ClrEnumerableConventionDifferentialTests asserts the answers by hand — so what is checked here is that the
