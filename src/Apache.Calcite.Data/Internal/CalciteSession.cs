...
namespace Apache.Calcite.Data
{
    ...
    /// is opened. This is the boundary between the public ADO.NET surface and the internal Calcite engine.
    /// </summary>
    internal sealed class CalciteSession : IDisposable
    {
        ...
        /// <summary>
        /// Gets the engine client used to dispatch requests for this session.
        /// </summary>
