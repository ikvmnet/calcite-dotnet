    ...
    internal readonly struct CalciteResultRow
    {
        ...
        public CalciteResultValue GetValue(int ordinal)
        {
            ...
            if (style == Meta.Style.OBJECT)
            {
                ...
                return new CalciteResultValue(_columns.GetProviderTypeName(ordinal), _row);
            }
            ...
            if (style == Meta.Style.ARRAY)
            {
                ...
                return new CalciteResultValue(_columns.GetProviderTypeName(ordinal), ((object[])_row)[ordinal]);
            }
            ...
            if (style == Meta.Style.LIST)
            {
                ...
                return new CalciteResultValue(_columns.GetProviderTypeName(ordinal), ((java.util.List)_row).get(ordinal));
            }
