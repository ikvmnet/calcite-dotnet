...
namespace Apache.Calcite.Data.Internal
{
    ...
    /// </summary>
    /// <remarks>
    /// The cursor is the plan's own: a <see cref="ClrDataCursor"/> with <see cref="ClrDataCursor.Read"/> and
    /// <see cref="ClrDataCursor.ReadAsync"/> over one position, so <see cref="Read"/> is the one and
    ...
    /// key.</para>
    /// </remarks>
    internal sealed class CalciteDataCursorResult : CalciteResult
    {

        readonly ClrDataCursor? _cursor;
        ...
        public CalciteDataCursorResult(IClrPrepare.Signature signature, ClrTypeRegistry registry, ClrDataCursor? cursor, long recordsAffected = -1, IDisposable? dataContext = null, CancellationTokenSource? cancellation = null) :
